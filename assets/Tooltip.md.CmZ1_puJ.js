import{m as t}from"./chunks/theme.DVqxVbXL.js";import{u as o}from"./chunks/Table.BP7XEx9l.js";import{B as s}from"./chunks/Button.r_O5p8SK.js";import{C as u,o as h,c as m,a4 as c,E as p,k as i,j as r,a}from"./chunks/framework.DuWTyC0X.js";import"./chunks/Button.module.DDCwNdEl.js";function g(n){t.mount(n,{view(){return t("div",{style:{display:"flex",gap:"16px",alignItems:"center",padding:"8px"}},t(o.Root,{placement:"top",showArrow:!0},t(o.Trigger,null,t(s,null,"Hover me")),t(o.Content,null,"上側に表示されるツールチップです。")),t(o.Root,{placement:"right",interactive:!0,showArrow:!0},t(o.Trigger,null,t("span",{style:{padding:"4px 8px",background:"#eee",borderRadius:"4px"}},"Info")),t(o.Content,null,"右側に表示されます。")))}})}function T(n){t.mount(n,{view(){return t(o.Root,{placement:"bottom",showArrow:!0,interactive:!0,openDelay:120,closeDelay:180},t(o.Trigger,null,t("span",{style:{display:"inline-flex",alignItems:"center",gap:"8px",padding:"8px 12px",borderRadius:"999px",background:"#eff6ff",color:"#1d4ed8",fontWeight:"600",cursor:"default"}},"Sensor T-12")),t(o.Content,null,t("div",{style:{display:"grid",gap:"6px",minWidth:"220px"}},t("div",{style:{fontWeight:"700"}},"Sensor T-12"),t("div",null,"最新温度: 812℃"),t("div",null,"更新周期: 1 sec"),t("div",{style:{color:"#94a3b8",fontSize:"0.85rem"}},"interactive=true のため内容上へポインタを移せます。"))))}})}function b(n){let d=!1;t.mount(n,{view(){return t("div",{style:{display:"grid",gap:"12px",alignItems:"start"}},t(s,{onclick:()=>{d=!d,t.redraw()}},d?"固定表示を解除":"固定表示する"),t(o.Root,{open:d,onOpenChange:e=>{d=e.open,t.redraw()},placement:"bottom",showArrow:!0},t(o.Trigger,null,t("span",{style:{padding:"6px 10px",borderRadius:"8px",background:"#f1f5f9",cursor:"default"}},"Batch summary")),t(o.Content,null,t("div",{style:{display:"grid",gap:"4px"}},t("div",null,"Recipe: Stoneware A"),t("div",null,"Stage: Hold"),t("div",null,"Target: 850℃")))),t("div",{style:{color:"#475569",fontSize:"0.9rem"}},"open: ",d?"true":"false"))}})}const f=`/** @jsx m */\r
import m from "mithril";\r
import { Tooltip, Button } from "mithril-ui-kit";\r
\r
    ...
    view() {\r
      return (\r
        <div style={{ display: "grid", gap: "12px", alignItems: "start" }}>\r
          <Button onclick={() => { open = !open; m.redraw(); }}>\r
