...
}`,q=JSON.parse('{"title":"Tooltip","description":"","frontmatter":{},"headers":[],"relativePath":"Tooltip.md","filePath":"Tooltip.md","lastUpdated":1778223170000}'),x={name:"Tooltip.md"},R=Object.assign(x,{setup(n){return(d,e)=>{const l=s("MithrilDemo");return u(),h("div",null,[e[0]||(e[0]=c("",6)),p(l,{setup:i(m),code:i(T)},null,8,["setup","code"]),e[1]||(e[1]=r("h3",{id:"interactive-コンテンツ",tabindex:"-1"},[a("interactive コンテンツ "),r("a",{class:"header-anchor",href:"#interactive-コンテンツ","aria-label":'Permalink to "interactive コンテンツ"'},"​")],-1)),e[2]||(e[2]=r("p",null,[r("code",null,"interactive"),a(" を有効にすると、ツールチップ本体へマウスを載せても閉じにくくなります。")],-1)),p(l,{setup:i(g),code:i(f)},null,8,["setup","code"]),e[3]||(e[3]=r("h3",{id:"制御モード",tabindex:"-1"},[a("制御モード "),r("a",{class:"header-anchor",href:"#制御モード","aria-label":'Permalink to "制御モード"'},"​")],-1)),e[4]||(e[4]=r("p",null,[r("code",null,"open"),a(" と "),r("code",null,"onOpenChange"),a(" を使うと、外部トグルやアプリ状態と同期できます。")],-1)),p(l,{setup:i(b),code:i(v)},null,8,["setup","code"]),e[5]||(e[5]=c("",13))])}}});export{q as __pageData,R as default};
