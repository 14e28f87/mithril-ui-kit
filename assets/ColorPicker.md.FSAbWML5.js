import{m as t}from"./chunks/theme.DVqxVbXL.js";import{m as e}from"./chunks/Table.BP7XEx9l.js";import{C as u,o as h,c as C,a4 as a,E as c,k as n,j as i,a as m}from"./chunks/framework.DuWTyC0X.js";function P(d){let o="#3b82f6";t.mount(d,{view(){return t("div",{class:"d-grid gap-2",style:{maxWidth:"360px"}},t(e.Root,{value:o,format:"hexa",onValueChange:({value:r})=>{o=r,t.redraw()}},t(e.Label,null,"テーマカラー"),t(e.Control,null,t(e.Input,null),t(e.Trigger,null)),t(e.Positioner,null,t(e.Content,null,t(e.Area,null),t(e.ChannelSlider,{channel:"hue"}),t(e.ChannelSlider,{channel:"alpha"})))),t("div",{class:"small text-muted"},`現在値: ${o}`))}})}const s=["#ef4444","#f59e0b","#10b981","#3b82f6","#8b5cf6"];function p(d){let o=s[3];t.mount(d,{view(){return t("div",{class:"d-grid gap-2",style:{maxWidth:"360px"}},t(e.Root,{value:o,onValueChange:({value:r})=>{o=r,t.redraw()}},t(e.Label,null,"プリセット色"),t(e.Control,null,t(e.Input,null),t(e.Trigger,null)),t(e.Positioner,null,t(e.Content,null,t(e.SwatchGroup,null,s.map(r=>t(e.SwatchTrigger,{key:r,value:r})))))),t("div",{class:"small text-muted"},`現在値: ${o}`))}})}const k=`/** @jsx m */\r
        ...
        <div class="d-grid gap-2" style={{ maxWidth: "360px" }}>\r
          ...
          >\r
            ...
            <ColorPicker.Control>\r
              <ColorPicker.Input />\r
              <ColorPicker.Trigger></ColorPicker.Trigger>\r
            </ColorPicker.Control>\r
