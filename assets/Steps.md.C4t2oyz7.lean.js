...
}`,P=JSON.parse('{"title":"Steps","description":"","frontmatter":{},"headers":[],"relativePath":"Steps.md","filePath":"Steps.md","lastUpdated":1778223170000}'),v={name:"Steps.md"},q=Object.assign(v,{setup(s){return(d,r)=>{const n=u("MithrilDemo");return g(),S("div",null,[r[0]||(r[0]=c("",6)),a(n,{setup:i(m),code:i(b)},null,8,["setup","code"]),r[1]||(r[1]=o("h3",{id:"制御モード",tabindex:"-1"},[p("制御モード "),o("a",{class:"header-anchor",href:"#制御モード","aria-label":'Permalink to "制御モード"'},"​")],-1)),r[2]||(r[2]=o("p",null,[o("code",null,"step"),p(" と "),o("code",null,"onStepChange"),p(" を使うと、外部状態と同期したステップ管理やリセット処理を実装できます。")],-1)),a(n,{setup:i(x),code:i(h)},null,8,["setup","code"]),r[3]||(r[3]=o("h3",{id:"縦配置",tabindex:"-1"},[p("縦配置 "),o("a",{class:"header-anchor",href:"#縦配置","aria-label":'Permalink to "縦配置"'},"​")],-1)),r[4]||(r[4]=o("p",null,[o("code",null,'orientation="vertical"'),p(" は、設定ウィザードや作業手順のサイド表示に向いています。")],-1)),a(n,{setup:i(f),code:i(T)},null,8,["setup","code"]),r[5]||(r[5]=c("",11))])}}});export{P as __pageData,q as default};
