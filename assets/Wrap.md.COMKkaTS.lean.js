import{m as n}from"./chunks/theme.CfoDaTyb.js";import{c as x}from"./chunks/Table.DljJUTvN.js";import{C as y,o as P,c as T,a4 as i,E as q,k as p}from"./chunks/framework.DuWTyC0X.js";const k="_wrap_ns57k_1",w={wrap:k};class W{view(t){const{gap:e="8px",rowGap:a,columnGap:o,align:l,justify:s,as:u="div",class:m,style:d,...f}=t.attrs,r={};e!==void 0&&(r.gap=typeof e=="number"?`${e}px`:e),a!==void 0&&(r.rowGap=typeof a=="number"?`${a}px`:a),o!==void 0&&(r.columnGap=typeof o=="number"?`${o}px`:o),l&&(r.alignItems=l),s&&(r.justifyContent=s);const h=typeof d=="string"?`${Object.entries(r).map(([b,g])=>`${b.replace(/[A-Z]/g,_=>`-${_.toLowerCase()}`)}:${g}`).join(";")}${d?`;${d}`:""}`:{...r,...d||{}};return n(u,{...f,class:x(w.wrap,m),style:h},t.children)}}const A=[{label:"Temperature",color:"#dbeafe"},{label:"Pressure",color:"#dcfce7"},{label:"OPC UA",color:"#fef3c7"},{label:"Batch",color:"#ede9fe"},{label:"Alarm",color:"#fee2e2"},{label:"Trend",color:"#e0f2fe"}];function C(c){n.mount(c,{view(){return n(W,{gap:"10px"},A.map(t=>n("span",{key:t.label,style:{padding:"8px 12px",borderRadius:"999px",background:t.color,fontWeight:"600"}},t.label)))}})}const v=`/** @jsx m */\r
