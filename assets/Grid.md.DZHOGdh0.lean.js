...
}`,U=JSON.parse('{"title":"Grid","description":"","frontmatter":{},"headers":[],"relativePath":"Grid.md","filePath":"Grid.md","lastUpdated":1776646114000}'),O={name:"Grid.md"},B=Object.assign(O,{setup(s){return(n,r)=>{const i=R("MithrilDemo");return T(),$("div",null,[r[0]||(r[0]=x("",5)),k(i,{setup:y(j),code:y(V)},null,8,["setup","code"]),r[1]||(r[1]=x("",7))])}}});export{U as __pageData,B as default};
