...
`,v=JSON.parse('{"title":"Offcanvas","description":"","frontmatter":{},"headers":[],"relativePath":"Offcanvas.md","filePath":"Offcanvas.md","lastUpdated":1776909368000}'),c={name:"Offcanvas.md"},F=Object.assign(c,{setup(e){return(n,t)=>{const i=d("MithrilDemo");return p(),k("div",null,[t[0]||(t[0]=l('<h1 id="offcanvas" tabindex="-1">Offcanvas <a class="header-anchor" href="#offcanvas" aria-label="Permalink to &quot;Offcanvas&quot;">​</a></h1><h2 id="概要" tabindex="-1">概要 <a class="header-anchor" href="#概要" aria-label="Permalink to &quot;概要&quot;">​</a></h2><p>オフキャンバスコンポーネント。<strong>命令的 API</strong>（<code>Offcanvas.show()</code> / <code>Offcanvas2.show()</code>）と<strong>宣言的 API</strong>（JSX component）の 2 つの使い方をサポートしています。</p><table tabindex="0"><thead><tr><th>特徴</th><th>説明</th></tr></thead><tbody><tr><td>サイズ</td><td><code>sm</code>, <code>md</code>, <code>lg</code>, <code>xl</code>, <code>full</code> の 5 段階</td></tr><tr><td>配置</td><td><code>start</code>, <code>end</code>（デフォルト）, <code>top</code>, <code>bottom</code></td></tr><tr><td>アニメーション</td><td>配置に応じたスライド</td></tr><tr><td>キーボード</td><td>Escape キーで閉じる（デフォルト有効）</td></tr><tr><td>外側クリック</td><td>バックドロップクリックで閉じる（デフォルト有効）</td></tr></tbody></table><h2 id="デモ" tabindex="-1">デモ <a class="header-anchor" href="#デモ" aria-label="Permalink to &quot;デモ&quot;">​</a></h2>',5)),r(i,{setup:h(o),code:h(E)},null,8,["setup","code"]),t[1]||(t[1]=l(`<h2 id="使い方-—-命令的-api-offcanvas-show" tabindex="-1">使い方 — 命令的 API（Offcanvas.show） <a class="header-anchor" href="#使い方-—-命令的-api-offcanvas-show" aria-label="Permalink to &quot;使い方 — 命令的 API（Offcanvas.show）&quot;">​</a></h2><p><code>Offcanvas.show()</code> は Promise を返す。コンテンツコンポーネントには <code>resolve</code> と <code>hide</code> が attrs に注入される。</p><div class="language-tsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">tsx</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Offcanvas } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;mithril-ui-kit&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">console.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">log</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(result); </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// true or false</span></span></code></pre></div><h2 id="使い方-—-宣言的-api-jsx-component" tabindex="-1">使い方 — 宣言的 API（JSX Component） <a class="header-anchor" href="#使い方-—-宣言的-api-jsx-component" aria-label="Permalink to &quot;使い方 — 宣言的 API（JSX Component）&quot;">​</a></h2><div class="language-tsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">tsx</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Offcanvas } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;mithril-ui-kit&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"></span>
