...
`,lt=JSON.parse('{"title":"Combobox","description":"","frontmatter":{},"headers":[],"relativePath":"Combobox.md","filePath":"Combobox.md","lastUpdated":1782952469000}'),Ye={name:"Combobox.md"},rt=Object.assign(Ye,{setup(i){return(l,t)=>{const d=Q("MithrilDemo");return Y(),Z("div",null,[t[0]||(t[0]=W('<h1 id="combobox" tabindex="-1">Combobox <a class="header-anchor" href="#combobox" aria-label="Permalink to &quot;Combobox&quot;">​</a></h1><h2 id="概要" tabindex="-1">概要 <a class="header-anchor" href="#概要" aria-label="Permalink to &quot;概要&quot;">​</a></h2><p><code>Combobox</code> は検索可能な選択 UI です。テキスト入力で候補を絞り込みつつ選択できるため、項目数が多いモード選択やデバイス選択で使いやすくなります。グループ表示・複数選択・新規値作成（Creatable）・非同期ロードなど多彩な用途に対応します。</p><h2 id="usage-使用例" tabindex="-1">Usage 使用例 <a class="header-anchor" href="#usage-使用例" aria-label="Permalink to &quot;Usage 使用例&quot;">​</a></h2><h3 id="基本" tabindex="-1">基本 <a class="header-anchor" href="#基本" aria-label="Permalink to &quot;基本&quot;">​</a></h3>',5)),_(d,{setup:c(Te),code:c(Le)},null,8,["setup","code"]),t[1]||(t[1]=r("h3",{id:"複数選択",tabindex:"-1"},[s("複数選択 "),r("a",{class:"header-anchor",href:"#複数選択","aria-label":'Permalink to "複数選択"'},"​")],-1)),t[2]||(t[2]=r("p",null,[r("code",null,"multiple"),s(" を指定すると複数のアイテムをタグ形式で選択できます。")],-1)),_(d,{setup:c(Pe),code:c(Ve)},null,8,["setup","code"]),t[3]||(t[3]=r("h3",{id:"バリアント",tabindex:"-1"},[s("バリアント "),r("a",{class:"header-anchor",href:"#バリアント","aria-label":'Permalink to "バリアント"'},"​")],-1)),t[4]||(t[4]=r("p",null,[r("code",null,"variant"),s(" で外観を切り替えます。")],-1)),_(d,{setup:c(Ee),code:c(je)},null,8,["setup","code"]),t[5]||(t[5]=r("h3",{id:"サイズ",tabindex:"-1"},[s("サイズ "),r("a",{class:"header-anchor",href:"#サイズ","aria-label":'Permalink to "サイズ"'},"​")],-1)),t[6]||(t[6]=r("p",null,[r("code",null,"size"),s(" で入力欄のサイズを変更します。")],-1)),_(d,{setup:c($e),code:c(Ne)},null,8,["setup","code"]),t[7]||(t[7]=r("h3",{id:"creatable-新規値の作成",tabindex:"-1"},[s("Creatable（新規値の作成） "),r("a",{class:"header-anchor",href:"#creatable-新規値の作成","aria-label":'Permalink to "Creatable（新規値の作成）"'},"​")],-1)),t[8]||(t[8]=r("p",null,[r("code",null,"creatable"),s(" を指定すると、リストにない値を入力して追加できます。"),r("code",null,"onCreateItem"),s(" コールバックで受け取り、"),r("code",null,"items"),s(" に追加します。")],-1)),_(d,{setup:c(We),code:c(He)},null,8,["setup","code"]),t[9]||(t[9]=r("h3",{id:"グループ表示",tabindex:"-1"},[s("グループ表示 "),r("a",{class:"header-anchor",href:"#グループ表示","aria-label":'Permalink to "グループ表示"'},"​")],-1)),t[10]||(t[10]=r("p",null,[r("code",null,"ComboboxItem"),s(" の "),r("code",null,"group"),s(" フィールドを指定すると、アイテムがグループラベルつきで表示されます。")],-1)),_(d,{setup:c(Be),code:c(Je)},null,8,["setup","code"]),t[11]||(t[11]=r("h3",{id:"無効状態・エラー状態",tabindex:"-1"},[s("無効状態・エラー状態 "),r("a",{class:"header-anchor",href:"#無効状態・エラー状態","aria-label":'Permalink to "無効状態・エラー状態"'},"​")],-1)),t[12]||(t[12]=r("p",null,[r("code",null,"disabled"),s(" でコンポーネント全体を無効化します。"),r("code",null,"invalid"),s(" でエラー状態の赤いボーダーを表示します。個別アイテムの "),r("code",null,"disabled"),s(" も指定できます。")],-1)),_(d,{setup:c(Fe),code:c(Ge)},null,8,["setup","code"]),t[13]||(t[13]=r("h3",{id:"非同期ロード",tabindex:"-1"},[s("非同期ロード "),r("a",{class:"header-anchor",href:"#非同期ロード","aria-label":'Permalink to "非同期ロード"'},"​")],-1)),t[14]||(t[14]=r("p",null,[r("code",null,"minChars"),s(" で最小入力文字数を設定し、入力イベントで "),r("code",null,"items"),s(" を非同期更新することでAPIドリブンな検索UIを実現できます。")],-1)),_(d,{setup:c(Ke),code:c(Qe)},null,8,["setup","code"]),t[15]||(t[15]=W('<h2 id="api-reference" tabindex="-1">API Reference <a class="header-anchor" href="#api-reference" aria-label="Permalink to &quot;API Reference&quot;">​</a></h2><h3 id="combobox-root-props" tabindex="-1">Combobox.Root Props <a class="header-anchor" href="#combobox-root-props" aria-label="Permalink to &quot;Combobox.Root Props&quot;">​</a></h3><table tabindex="0"><thead><tr><th>Props</th><th>Type</th><th>Default</th><th>Description</th></tr></thead><tbody><tr><td><code>variant</code></td><td><code>&quot;outline&quot; | &quot;subtle&quot; | &quot;flushed&quot;</code></td><td><code>&quot;outline&quot;</code></td><td>見た目のバリエーションです</td></tr><tr><td><code>size</code></td><td><code>&quot;xs&quot; | &quot;sm&quot; | &quot;md&quot; | &quot;lg&quot;</code></td><td><code>&quot;md&quot;</code></td><td>入力欄サイズです</td></tr><tr><td><code>items</code></td><td><code>ComboboxItem[]</code></td><td>—</td><td>選択候補一覧です</td></tr><tr><td><code>value</code></td><td><code>string | string[]</code></td><td>—</td><td>現在値です</td></tr><tr><td><code>onValueChange</code></td><td><code>(value: string | string[]) =&gt; void</code></td><td>—</td><td>値変更時に呼ばれます</td></tr><tr><td><code>multiple</code></td><td><code>boolean</code></td><td><code>false</code></td><td>複数選択モードです</td></tr><tr><td><code>openOnClick</code></td><td><code>boolean</code></td><td><code>true</code></td><td>フォーカス時に一覧を開きます</td></tr><tr><td><code>placeholder</code></td><td><code>string</code></td><td><code>&quot;検索...&quot;</code></td><td>入力プレースホルダーです</td></tr><tr><td><code>disabled</code></td><td><code>boolean</code></td><td><code>false</code></td><td>無効化します</td></tr><tr><td><code>invalid</code></td><td><code>boolean</code></td><td><code>false</code></td><td>エラー状態のボーダーを表示します</td></tr><tr><td><code>creatable</code></td><td><code>boolean</code></td><td><code>false</code></td><td>リストにない値の新規作成を許可します</td></tr><tr><td><code>onCreateItem</code></td><td><code>(value: string) =&gt; void</code></td><td>—</td><td>新規値が作成されたときに呼ばれます</td></tr><tr><td><code>minChars</code></td><td><code>number</code></td><td><code>0</code></td><td>ドロップダウンを開く最小入力文字数です（0 = 制限なし）</td></tr><tr><td><code>class</code></td><td><code>string</code></td><td>—</td><td>追加クラスです</td></tr></tbody></table><h3 id="comboboxitem" tabindex="-1">ComboboxItem <a class="header-anchor" href="#comboboxitem" aria-label="Permalink to &quot;ComboboxItem&quot;">​</a></h3><table tabindex="0"><thead><tr><th>プロパティ</th><th>Type</th><th>Description</th></tr></thead><tbody><tr><td><code>value</code></td><td><code>string</code></td><td>アイテムの値です</td></tr><tr><td><code>label</code></td><td><code>string</code></td><td>表示ラベルです</td></tr><tr><td><code>disabled</code></td><td><code>boolean</code></td><td>このアイテムを無効化します</td></tr><tr><td><code>group</code></td><td><code>string</code></td><td>グループ名を指定するとグループラベルが表示されます</td></tr></tbody></table>',5))])}}});export{lt as __pageData,rt as default};
