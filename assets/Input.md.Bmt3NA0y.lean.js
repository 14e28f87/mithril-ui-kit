import{m as t}from"./chunks/theme.CfoDaTyb.js";import"./chunks/Table.DljJUTvN.js";import{I as l}from"./chunks/Input.DL_4MKv9.js";import{C as u,o as p,c as m,a4 as i,E as c,k as a,j as r,a as n}from"./chunks/framework.DuWTyC0X.js";function h(o){let d="mithril-user";t.mount(o,{view(){return t("div",null,t(l,{value:d,placeholder:"ユーザー名を入力",oninput:e=>{d=e,t.redraw()}}),t("div",{class:"mt-2 text-muted small"},`現在値: ${d??"(null)"}`))}})}function v(o){const d={text:"",password:""};t.mount(o,{view(){return t("div",{class:"d-flex flex-column gap-3"},t("div",null,t("label",{class:"form-label"},"text（通常）"),t(l,{value:d.text,placeholder:"テキストを入力",oninput:e=>{d.text=e??"",t.redraw()}})),t("div",null,t("label",{class:"form-label"},"password"),t(l,{type:"password",value:d.password,placeholder:"パスワードを入力",oninput:e=>{d.password=e??"",t.redraw()}})),t("div",null,t("label",{class:"form-label"},"disabled"),t(l,{value:"編集不可の固定値",disabled:!0})),t("div",{class:"text-muted small"},`text: "${d.text}" / password: "${d.password}"`))}})}const b=`/** @jsx m */\r
