    ...
    view() {\r
      return (\r
        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>\r
          ...
          >\r
            <Pagination.PrevTrigger>←</Pagination.PrevTrigger>\r
            <Pagination.Items />\r
            <Pagination.PageText format="long" />\r
            <Pagination.NextTrigger>→</Pagination.NextTrigger>\r
          </Pagination.Root>\r
\r
      ...
      return (\r
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>\r
          <div>\r
            ...
            <Pagination.Root count={100} pageSize={10} variant="solid" size="lg" defaultPage={3}>\r
              <Pagination.PrevTrigger>←</Pagination.PrevTrigger>\r
              <Pagination.Items />\r
              <Pagination.NextTrigger>→</Pagination.NextTrigger>\r
            </Pagination.Root>\r
          ...
          <div>\r
            ...
            <Pagination.Root count={100} pageSize={10} variant="subtle" size="sm" defaultPage={3}>\r
              <Pagination.PrevTrigger>←</Pagination.PrevTrigger>\r
              <Pagination.Items />\r
              <Pagination.NextTrigger>→</Pagination.NextTrigger>\r
            </Pagination.Root>\r
...
export function setup(el: HTMLElement): void {\r
  m.mount(el, {\r
    view() {\r
      return (\r
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>\r
          <Pagination.Root count={300} pageSize={15} defaultPage={5}>\r
            <Pagination.PrevTrigger>←</Pagination.PrevTrigger>\r
            <Pagination.Items />\r
            <Pagination.PageText format="short" />\r
            <Pagination.NextTrigger>→</Pagination.NextTrigger>\r
          </Pagination.Root>\r
