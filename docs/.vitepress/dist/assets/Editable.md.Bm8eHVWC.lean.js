...
}`,f=JSON.parse('{"title":"Editable","description":"","frontmatter":{},"headers":[],"relativePath":"Editable.md","filePath":"Editable.md"}'),v={name:"Editable.md"},_=Object.assign(v,{setup(r){return(o,e)=>{const n=u("MithrilDemo");return s(),b("div",null,[e[0]||(e[0]=l("",5)),i(n,{setup:a(g),code:a(p)},null,8,["setup","code"]),e[1]||(e[1]=c("h3",{id:"複数行編集",tabindex:"-1"},[m("複数行編集 "),c("a",{class:"header-anchor",href:"#複数行編集","aria-label":'Permalink to "複数行編集"'},"​")],-1)),i(n,{setup:a(h),code:a(E)},null,8,["setup","code"]),e[2]||(e[2]=l("",5))])}}});export{f as __pageData,_ as default};
