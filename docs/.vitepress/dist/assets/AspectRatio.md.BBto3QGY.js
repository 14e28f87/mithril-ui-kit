import{m as e}from"./chunks/theme.CIfTaYq1.js";import{c as h}from"./chunks/Table.B255pMpr.js";import{C as m,o as u,c as f,ai as n,E as _,k as s}from"./chunks/framework.Bm_aoSIc.js";const g="_aspectRatio_fjwl5_1",R={aspectRatio:g};class b{view(r){const{ratio:t=4/3,as:o="div",class:d,style:i,...c}=r.attrs,l={aspectRatio:String(t)},p=typeof i=="string"?`aspect-ratio:${t};${i}`:{...l,...i||{}};return e(o,{...c,class:h(R.aspectRatio,d),style:p},r.children)}}function A(a){e.mount(a,{view(){return e(b,{ratio:16/9},e("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",width:"100%",height:"100%",borderRadius:"14px",background:"linear-gradient(135deg, #111827, #334155)",color:"#f8fafc",fontWeight:"700",letterSpacing:"0.04em"}},"16:9 preview area"))}})}const P=`/** @jsx m */\r
