...
`,C=JSON.parse('{"title":"Switch","description":"","frontmatter":{},"headers":[],"relativePath":"Switch.md","filePath":"Switch.md","lastUpdated":null}'),u={name:"Switch.md"},y=Object.assign(u,{setup(s){return(e,a)=>{const n=h("MithrilDemo");return o(),r("div",null,[a[0]||(a[0]=d("",4)),c(n,{setup:l(k),code:l(p)},null,8,["setup","code"]),a[1]||(a[1]=d("",11))])}}});export{C as __pageData,y as default};
