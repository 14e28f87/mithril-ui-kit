...
`;function y(l){let a="なし";i.mount(l,{view(){return i("div",null,i(t.Root,{onSelect:s=>{a=s.value,i.redraw()}},i(t.ContextTrigger,null,i("div",{style:"border: 2px dashed #dee2e6; border-radius: 0.5rem; padding: 2rem; text-align: center; color: #6c757d; background: #f8f9fa; user-select: none;"},i("div",{style:"font-size: 0.875rem; margin-bottom: 0.5rem;"},"🖱️ この領域を右クリックしてください"),i("div",{style:"font-size: 0.75rem; opacity: 0.7;"},"Right-click to open context menu"))),i(t.Positioner,null,i(t.Content,null,i(t.Item,{value:"copy"},"📋 コピー"),i(t.Item,{value:"paste"},"📌 貼り付け"),i(t.Item,{value:"cut"},"✂️ 切り取り"),i(t.Separator,null),i(t.Item,{value:"select-all"},"☑️ すべて選択"),i(t.Separator,null),i(t.Item,{value:"delete",destructive:!0},"🗑️ 削除")))),i("div",{class:"mt-2 text-muted small"},`選択した操作: ${a}`))}})}const D=`/** @jsx m */\r
import m from "mithril";\r
import { Dropdown, type DropdownSelectDetails } from "mithril-ui-kit";\r
\r
export function setup(el: HTMLElement): void {\r
...
`;function v(l){let a="なし",s=!0,e=!1,r="dark",k="2";i.mount(l,{view(){return i("div",{style:"display:flex; gap:1rem; flex-wrap:wrap;"},i(t.Root,{onSelect:d=>{a=d.value,i.redraw()}},i(t.Trigger,null,"⚙️ Editor Settings ▾"),i(t.Positioner,null,i(t.Content,null,i(t.ItemGroup,{label:"表示"},i(t.CheckboxItem,{value:"preview",checked:s,onCheckedChange:d=>{s=d,i.redraw()}},"プレビュー表示"),i(t.CheckboxItem,{value:"line-numbers",checked:e,onCheckedChange:d=>{e=d,i.redraw()}},"行番号を表示")),i(t.Separator,null),i(t.ItemGroup,{label:"テーマ"},i(t.RadioItemGroup,{value:r,onValueChange:d=>{r=d,i.redraw()}},i(t.RadioItem,{value:"dark"},"🌙 Dark"),i(t.RadioItem,{value:"light"},"☀️ Light"),i(t.RadioItem,{value:"solarized"},"🎨 Solarized"))),i(t.Separator,null),i(t.ItemGroup,{label:"インデント幅"},i(t.RadioItemGroup,{value:k,onValueChange:d=>{k=d,i.redraw()}},i(t.RadioItem,{value:"2"},"2 スペース"),i(t.RadioItem,{value:"4"},"4 スペース"),i(t.RadioItem,{value:"tab"},"タブ"))),i(t.Separator,null),i(t.Item,{value:"reset"},"↩️ 設定をリセット"),i(t.Item,{value:"save"},"💾 設定を保存"),i(t.Separator,null),i(t.Item,{value:"uninstall",destructive:!0},"🗑️ 拡張機能を削除")))),i("div",{style:"font-size:0.8rem; color:#6c757d; padding:0.5rem; background:#f8f9fa; border-radius:0.375rem; border:1px solid #dee2e6;"},i("div",null,"Preview: ",s?"ON":"OFF"," | LineNums: ",e?"ON":"OFF"),i("div",null,"Theme: ",r," | Indent: ",k," spaces"),i("div",null,"Last: ",a)))}})}const b=`/** @jsx m */\r
import m from "mithril";\r
import { Dropdown, type DropdownSelectDetails } from "mithril-ui-kit";\r
\r
export function setup(el: HTMLElement): void {\r
