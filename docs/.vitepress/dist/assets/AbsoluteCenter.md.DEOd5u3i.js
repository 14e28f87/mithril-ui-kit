import{m as t}from"./chunks/theme.BkMwotUo.js";import{c as u}from"./chunks/Table.CoGcR3xC.js";import{C as h,o as b,c as p,a4 as d,E as f,k as i}from"./chunks/framework.DuWTyC0X.js";const _="_absoluteCenter_8hng0_1",m="_horizontal_8hng0_9",g="_vertical_8hng0_14",x="_both_8hng0_19",r={absoluteCenter:_,horizontal:m,vertical:g,both:x};class v{view(a){const{axis:e="both",as:n="div",class:s,...l}=a.attrs,c=e==="horizontal"?r.horizontal:e==="vertical"?r.vertical:r.both;return t(n,{...l,class:u(r.absoluteCenter,c,s)},a.children)}}function C(o){t.mount(o,{view(){return t("div",{style:{position:"relative",height:"160px",borderRadius:"14px",background:"linear-gradient(135deg, #dbeafe, #eff6ff)",border:"1px solid #bfdbfe"}},t("div",{style:{padding:"16px",color:"#1e3a8a",fontWeight:"600"}},"Relative parent"),t(v,null,t("div",{style:{padding:"10px 14px",borderRadius:"999px",background:"#ffffff",boxShadow:"0 8px 24px rgba(15, 23, 42, 0.12)",fontWeight:"600"}},"Centered overlay")))}})}const q=`/** @jsx m */\r
import m from "mithril";\r
import { AbsoluteCenter } from "mithriluikit";\r
\r
