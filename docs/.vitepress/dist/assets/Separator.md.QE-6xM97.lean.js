...
}`,j=JSON.parse('{"title":"Separator","description":"","frontmatter":{},"headers":[],"relativePath":"Separator.md","filePath":"Separator.md","lastUpdated":null}'),U={name:"Separator.md"},B=Object.assign(U,{setup(a){return(i,o)=>{const n=b("MithrilDemo");return v(),S("div",null,[o[0]||(o[0]=c("",5)),g(n,{setup:p(M),code:p(R)},null,8,["setup","code"]),o[1]||(o[1]=c("",3))])}}});export{j as __pageData,B as default};
