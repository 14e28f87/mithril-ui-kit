...
`,F=JSON.parse('{"title":"Modal","description":"","frontmatter":{},"headers":[],"relativePath":"Modal.md","filePath":"Modal.md"}'),c={name:"Modal.md"},b=Object.assign(c,{setup(d){return(n,i)=>{const a=h("MithrilDemo");return o(),r("div",null,[i[0]||(i[0]=l('<h1 id="modal" tabindex="-1">Modal <a class="header-anchor" href="#modal" aria-label="Permalink to &quot;Modal&quot;">​</a></h1><h2 id="概要" tabindex="-1">概要 <a class="header-anchor" href="#概要" aria-label="Permalink to &quot;概要&quot;">​</a></h2><p>Chakra UI Dialog 風の compound モーダルコンポーネント。<strong>命令的 API</strong>（<code>Modal.show()</code>）と<strong>宣言的 API</strong>（JSX compound component）の 2 つの使い方をサポート。</p><blockquote><p>レガシーの Bootstrap 5 スタイルモーダル（<code>ModalClassic</code>）は旧 API です。このページでは current API を案内します。</p></blockquote><table tabindex="0"><thead><tr><th>特徴</th><th>説明</th></tr></thead><tbody><tr><td>サイズ</td><td><code>xs</code>, <code>sm</code>, <code>md</code>, <code>lg</code>, <code>xl</code>, <code>cover</code>, <code>full</code> の 7 段階</td></tr><tr><td>配置</td><td><code>top</code>（デフォルト）, <code>center</code>, <code>bottom</code></td></tr><tr><td>スクロール</td><td><code>outside</code>（デフォルト）, <code>inside</code></td></tr><tr><td>アニメーション</td><td><code>scale</code>（デフォルト）, <code>none</code></td></tr><tr><td>キーボード</td><td>Escape キーで閉じる（デフォルト有効）</td></tr><tr><td>外側クリック</td><td>バックドロップクリックで閉じる（デフォルト有効）</td></tr></tbody></table><h2 id="デモ" tabindex="-1">デモ <a class="header-anchor" href="#デモ" aria-label="Permalink to &quot;デモ&quot;">​</a></h2>',6)),p(a,{setup:e(k),code:e(E)},null,8,["setup","code"]),i[1]||(i[1]=l(`<h2 id="使い方-—-命令的-api-modal-show" tabindex="-1">使い方 — 命令的 API（Modal.show） <a class="header-anchor" href="#使い方-—-命令的-api-modal-show" aria-label="Permalink to &quot;使い方 — 命令的 API（Modal.show）&quot;">​</a></h2><p><code>Modal.show()</code> は Promise を返す。コンテンツコンポーネントには <code>resolve</code> と <code>hide</code> が attrs に注入される。</p><div class="language-tsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">tsx</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Modal } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;mithril-ui-kit&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">console.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">log</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(result); </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// true or false</span></span></code></pre></div><h2 id="使い方-—-宣言的-api-jsx-compound-component" tabindex="-1">使い方 — 宣言的 API（JSX Compound Component） <a class="header-anchor" href="#使い方-—-宣言的-api-jsx-compound-component" aria-label="Permalink to &quot;使い方 — 宣言的 API（JSX Compound Component）&quot;">​</a></h2><div class="language-tsx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">tsx</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Modal, Portal } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;mithril-ui-kit&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"></span>
