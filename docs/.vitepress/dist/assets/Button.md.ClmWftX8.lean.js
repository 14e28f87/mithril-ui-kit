...
}`,I=JSON.parse('{"title":"Button","description":"","frontmatter":{},"headers":[],"relativePath":"Button.md","filePath":"Button.md","lastUpdated":null}'),D={name:"Button.md"},N=Object.assign(D,{setup(r){return(u,e)=>{const a=_("MithrilDemo");return x(),P("div",null,[e[0]||(e[0]=b("",5)),y(a,{setup:g(S),code:g(k)},null,8,["setup","code"]),e[1]||(e[1]=b("",5))])}}});export{I as __pageData,N as default};
