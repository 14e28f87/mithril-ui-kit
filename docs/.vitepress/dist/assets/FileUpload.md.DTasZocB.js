import{m as e}from"./chunks/theme.CIfTaYq1.js";import{F as t}from"./chunks/Table.B255pMpr.js";import{C as c,o as p,c as s,ai as l,E as u,k as a}from"./chunks/framework.Bm_aoSIc.js";let i=[];function h(d){e.mount(d,{view(){return e(t.Root,{multiple:!0,accept:".json,.csv",files:i,onFilesChange:r=>{i=r,e.redraw()}},e(t.Label,null,"Upload recipe files"),e(t.Dropzone,null,e(t.DropzoneContent,null,"Drag and drop files here, or click to browse.")),e(t.Trigger,null,"Select files"),e(t.ItemGroup,null))}})}const m=`/** @jsx m */\r
