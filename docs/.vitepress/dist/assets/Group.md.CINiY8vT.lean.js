...
}`,R=JSON.parse('{"title":"Group","description":"","frontmatter":{},"headers":[],"relativePath":"Group.md","filePath":"Group.md","lastUpdated":null}'),A={name:"Group.md"},$=Object.assign(A,{setup(o){return(n,t)=>{const c=P("MithrilDemo");return q(),G("div",null,[t[0]||(t[0]=p("",5)),k(c,{setup:u(C),code:u(S)},null,8,["setup","code"]),t[1]||(t[1]=p("",3))])}}});export{R as __pageData,$ as default};
