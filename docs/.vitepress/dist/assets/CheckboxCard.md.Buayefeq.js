import{m as t}from"./chunks/theme.MeAZuU5r.js";import{e}from"./chunks/Table.BlGpiJ_h.js";import{C as i,o as l,c as s,ai as c,E as C,k as n}from"./chunks/framework.DYURIDHw.js";let d=!0;function b(r){t.mount(r,{view(){return t("div",{style:{display:"grid",gap:"12px",maxWidth:"420px"}},t(e.Root,{checked:d,onCheckedChange:a=>{d=a}},t(e.Control,null,t(e.Content,null,t(e.Label,null,"通知を有効にする"),t(e.Description,null,"WebSocket の状態変化をトーストで表示します。")),t(e.Indicator,null))),t("div",{style:{color:"#475569",fontSize:"0.9rem"}},"Checked: ",d?"true":"false"))}})}const u=`/** @jsx m */\r
