...
}`,H=JSON.parse('{"title":"PinInput","description":"","frontmatter":{},"headers":[],"relativePath":"PinInput.md","filePath":"PinInput.md"}'),B={name:"PinInput.md"},J=Object.assign(B,{setup(f){return(e,t)=>{const d=R("MithrilDemo");return k(),S("div",null,[t[0]||(t[0]=b("",5)),A(d,{setup:z(O),code:z(U)},null,8,["setup","code"]),t[1]||(t[1]=b("",3))])}}});export{H as __pageData,J as default};
