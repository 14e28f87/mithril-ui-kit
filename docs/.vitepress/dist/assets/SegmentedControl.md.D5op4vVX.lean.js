import{m as t}from"./chunks/theme.BkMwotUo.js";import{S as e}from"./chunks/Table.CoGcR3xC.js";import{C as m,o as s,c,a4 as a,E as u,k as l}from"./chunks/framework.DuWTyC0X.js";let d="overview";function h(r){t.mount(r,{view(){return t("div",{style:{display:"grid",gap:"10px"}},t(e.Root,{value:d,onValueChange:n=>{d=n}},t(e.Item,{value:"overview"},t(e.ItemText,null,"Overview")),t(e.Item,{value:"history"},t(e.ItemText,null,"History")),t(e.Item,{value:"settings"},t(e.ItemText,null,"Settings"))),t("div",{style:{color:"#475569",fontSize:"0.9rem"}},"Current tab: ",d))}})}const g=`/** @jsx m */\r
import m from "mithril";\r
import { SegmentedControl } from "mithriluikit";\r
\r
