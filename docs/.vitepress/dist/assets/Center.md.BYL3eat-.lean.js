...
}`,N=JSON.parse('{"title":"Center","description":"","frontmatter":{},"headers":[],"relativePath":"Center.md","filePath":"Center.md","lastUpdated":null}'),w={name:"Center.md"},z=Object.assign(w,{setup(a){return(t,e)=>{const d=b("MithrilDemo");return _(),g("div",null,[e[0]||(e[0]=h("",5)),C(d,{setup:u(T),code:u(v)},null,8,["setup","code"]),e[1]||(e[1]=h("",7))])}}});export{N as __pageData,z as default};
