import{m as s}from"./chunks/theme.MeAZuU5r.js";import{k as i}from"./chunks/Table.BlGpiJ_h.js";import{C as r,o as l,c as p,ai as a,E as h,k as o}from"./chunks/framework.DYURIDHw.js";function k(t){s.mount(t,{view(){return s(i.Root,{placement:"bottom",size:"sm"},s(i.Trigger,null,"詳細を開く"),s(i.Content,null,s(i.Arrow,null),s(i.Header,null,"Popover2"),s(i.Body,null,"補足情報やアクションを含むポップオーバーです。"),s(i.Footer,null,s(i.CloseTrigger,null,"閉じる"))))}})}const d=`/** @jsx m */\r
