...
}`,X=JSON.parse('{"title":"ColorSwatch","description":"","frontmatter":{},"headers":[],"relativePath":"ColorSwatch.md","filePath":"ColorSwatch.md","lastUpdated":null}'),D={name:"ColorSwatch.md"},E=Object.assign(D,{setup(t){return(e,o)=>{const a=_("MithrilDemo");return m(),z("div",null,[o[0]||(o[0]=i("",5)),q(a,{setup:n(M),code:n(A)},null,8,["setup","code"]),o[1]||(o[1]=i("",5))])}}});export{X as __pageData,E as default};
