...
}`,H=JSON.parse('{"title":"TreeView","description":"","frontmatter":{},"headers":[],"relativePath":"TreeView.md","filePath":"TreeView.md"}'),$={name:"TreeView.md"},J=Object.assign($,{setup(a){return(e,t)=>{const r=x("MithrilDemo");return I(),b("div",null,[t[0]||(t[0]=m("",5)),g(r,{setup:p(j),code:p(K)},null,8,["setup","code"]),t[1]||(t[1]=m("",3))])}}});export{H as __pageData,J as default};
