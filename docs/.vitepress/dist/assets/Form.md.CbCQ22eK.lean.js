...
`,A=JSON.parse('{"title":"Form","description":"","frontmatter":{},"headers":[],"relativePath":"Form.md","filePath":"Form.md","lastUpdated":null}'),m={name:"Form.md"},D=Object.assign(m,{setup(l){return(h,i)=>{const a=E("MithrilDemo");return d(),g("div",null,[i[0]||(i[0]=k("",4)),F(a,{setup:p(o),code:p(y)},null,8,["setup","code"]),i[1]||(i[1]=k("",29))])}}});export{A as __pageData,D as default};
