...
}`,B=JSON.parse('{"title":"Stack","description":"","frontmatter":{},"headers":[],"relativePath":"Stack.md","filePath":"Stack.md","lastUpdated":null}'),I={name:"Stack.md"},M=Object.assign(I,{setup(d){return(e,o)=>{const c=w("MithrilDemo");return P(),C("div",null,[o[0]||(o[0]=g("",5)),T(c,{setup:b(H),code:b(j)},null,8,["setup","code"]),o[1]||(o[1]=g("",5))])}}});export{B as __pageData,M as default};
