import{m as t}from"./chunks/theme.BkMwotUo.js";import{a as e}from"./chunks/Table.CoGcR3xC.js";import{C as l,o as i,c as s,a4 as c,E as C,k as n}from"./chunks/framework.DuWTyC0X.js";let d=!0;function b(r){t.mount(r,{view(){return t("div",{style:{display:"grid",gap:"12px",maxWidth:"420px"}},t(e.Root,{checked:d,onCheckedChange:a=>{d=a}},t(e.Control,null,t(e.Content,null,t(e.Label,null,"通知を有効にする"),t(e.Description,null,"WebSocket の状態変化をトーストで表示します。")),t(e.Indicator,null))),t("div",{style:{color:"#475569",fontSize:"0.9rem"}},"Checked: ",d?"true":"false"))}})}const u=`/** @jsx m */\r
import m from "mithril";\r
import { CheckboxCard } from "mithriluikit";\r
\r
let checked = true;\r
\r
