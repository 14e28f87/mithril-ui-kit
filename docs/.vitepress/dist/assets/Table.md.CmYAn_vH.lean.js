...
}`,f=JSON.parse('{"title":"Table","description":"","frontmatter":{},"headers":[],"relativePath":"Table.md","filePath":"Table.md","lastUpdated":null}'),p={name:"Table.md"},q=Object.assign(p,{setup(a){return(o,d)=>{const n=c("MithrilDemo");return s(),u("div",null,[d[0]||(d[0]=r("",5)),i(n,{setup:l(b),code:l(h)},null,8,["setup","code"]),d[1]||(d[1]=r("",5))])}}});export{f as __pageData,q as default};
