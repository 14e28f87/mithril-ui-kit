import{m as e}from"./chunks/theme.4JftMPzn.js";import{c as i}from"./chunks/Table.BtqtxzWS.js";import{C as c,o as l,c as h,ai as a,E as p,k as n}from"./chunks/framework.Bm_aoSIc.js";const f="_box_dlrng_1",m={box:f};class u{view(r){const{as:t="div",class:d,...s}=r.attrs;return e(t,{...s,class:i(m.box,d)},r.children)}}function x(o){e.mount(o,{view(){return e(u,{as:"section",style:{padding:"16px",border:"1px solid #d0d7de",borderRadius:"12px",background:"linear-gradient(135deg, #fff7ed, #ffffff)"}},e("div",{style:{fontWeight:"600",marginBottom:"8px"}},"Box"),e("div",null,"as、class、style を受け取り、任意の HTML 要素を薄くラップできます。"))}})}const _=`/** @jsx m */\r
