...
}`,O=JSON.parse('{"title":"Float","description":"","frontmatter":{},"headers":[],"relativePath":"Float.md","filePath":"Float.md","lastUpdated":null}'),U={name:"Float.md"},B=Object.assign(U,{setup(t){return(d,e)=>{const s=y("MithrilDemo");return C(),P("div",null,[e[0]||(e[0]=c("",5)),S(s,{setup:p(W),code:p(w)},null,8,["setup","code"]),e[1]||(e[1]=c("",5))])}}});export{O as __pageData,B as default};
