import{m as t}from"./chunks/theme.D5gNcpBr.js";import{p as r}from"./chunks/Table.A5W0Ssaz.js";import{C as l,o as u,c as i,ai as n,E as c,k as d}from"./chunks/framework.Bm_aoSIc.js";const p=[{value:"info",label:"Waiting"},{value:"warning",label:"Warning"},{value:"success",label:"Running"},{value:"error",label:"Stopped"}];function h(o){t.mount(o,{view(){return t("div",{style:{display:"grid",gap:"10px"}},p.map(e=>t(r.Root,{key:e.label,value:e.value},t(r.Indicator,null),t("span",{style:{marginLeft:"8px"}},e.label))))}})}const m=`/** @jsx m */\r
