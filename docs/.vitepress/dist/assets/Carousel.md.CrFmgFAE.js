import{m as t}from"./chunks/theme.BkMwotUo.js";import{q as r}from"./chunks/Table.CoGcR3xC.js";import{C as p,o as g,c as m,a4 as u,E as c,k as i,j as n,a as s}from"./chunks/framework.DuWTyC0X.js";function h(a){const o=[{title:"Kiln A",text:"現在温度 812℃",bg:"#dbeafe"},{title:"Kiln B",text:"現在温度 624℃",bg:"#dcfce7"},{title:"Kiln C",text:"保持工程 12 min",bg:"#fef3c7"}];t.mount(a,{view(){return t("div",{style:{maxWidth:"520px"}},t(r.Root,{slideCount:o.length,loop:!0,autoplay:3200},t(r.Control,null,t(r.PrevTrigger,null,"◀"),t(r.NextTrigger,null,"▶")),t(r.ItemGroup,null,o.map((e,d)=>t(r.Item,{index:d,key:e.title},t("div",{style:{background:e.bg,padding:"24px",borderRadius:"14px",minHeight:"150px",display:"grid",alignContent:"start",gap:"8px"}},t("strong",null,e.title),t("div",null,e.text),t("div",{style:{color:"#475569",fontSize:"0.9rem"}},"バッチ監視カードの切り替え例です。"))))),t(r.IndicatorGroup,null,o.map((e,d)=>t(r.Indicator,{index:d,key:d})))))}})}function C(a){const o=["Temperature","Pressure","Power","Gas"];t.mount(a,{view(){return t("div",{style:{maxWidth:"620px"}},t(r.Root,{slideCount:o.length,slidesPerPage:2},t(r.Control,null,t(r.PrevTrigger,null,"Prev"),t(r.NextTrigger,null,"Next")),t(r.ItemGroup,null,o.map((e,d)=>t(r.Item,{index:d,key:e},t("div",{style:{marginRight:"12px",padding:"18px",borderRadius:"14px",border:"1px solid #d0d7de",background:"#ffffff",minHeight:"120px"}},t("div",{style:{fontWeight:"700",marginBottom:"6px"}},e),t("div",{style:{color:"#475569",fontSize:"0.9rem"}},"2 枚ずつ表示するギャラリー例です。"))))),t(r.IndicatorGroup,null,t(r.Indicator,{index:0}),t(r.Indicator,{index:1}))))}})}function x(a){let o=0;const e=["Overview","Trend","Alarm"];t.mount(a,{view(){return t("div",{style:{display:"grid",gap:"12px",maxWidth:"520px"}},t("div",{style:{display:"flex",gap:"8px",flexWrap:"wrap"}},e.map((d,l)=>t("button",{type:"button",class:"vp-button",onclick:()=>{o=l,t.redraw()}},d))),t(r.Root,{page:o,onPageChange:d=>{o=d.page,t.redraw()},slideCount:e.length},t(r.Control,null,t(r.PrevTrigger,null,"◀"),t(r.NextTrigger,null,"▶")),t(r.ItemGroup,null,e.map((d,l)=>t(r.Item,{index:l,key:d},t("div",{style:{padding:"24px",borderRadius:"14px",background:"#f8fafc",minHeight:"140px"}},t("div",{style:{fontWeight:"700",marginBottom:"8px"}},d),t("div",{style:{color:"#475569"}},"外部状態で page を制御しているデモです。"))))),t(r.IndicatorGroup,null,e.map((d,l)=>t(r.Indicator,{index:l,key:l})))),t("div",{style:{color:"#475569",fontSize:"0.9rem"}},"current page: ",o))}})}const b=`/** @jsx m */\r
import m from "mithril";\r
import { Carousel } from "mithriluikit";\r
\r
...
import m from "mithril";\r
import { Carousel } from "mithriluikit";\r
import type { CarouselPageChangeDetails } from "mithriluikit";\r
\r
export function setup(el: HTMLElement): void {\r
  let page = 0;\r
