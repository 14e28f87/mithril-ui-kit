...
`,F=JSON.parse('{"title":"Modal","description":"","frontmatter":{},"headers":[],"relativePath":"Modal.md","filePath":"Modal.md"}'),c={name:"Modal.md"},b=Object.assign(c,{setup(d){return(n,i)=>{const a=h("MithrilDemo");return o(),r("div",null,[i[0]||(i[0]=l("",6)),p(a,{setup:e(k),code:e(E)},null,8,["setup","code"]),i[1]||(i[1]=l("",16))])}}});export{F as __pageData,b as default};
