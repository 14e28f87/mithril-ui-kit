...
}`,x=JSON.parse('{"title":"Toast","description":"","frontmatter":{},"headers":[],"relativePath":"Toast.md","filePath":"Toast.md","lastUpdated":null}'),b={name:"Toast.md"},k=Object.assign(b,{setup(d){return(T,e)=>{const n=i("MithrilDemo");return l(),u("div",null,[e[0]||(e[0]=a("",7)),p(n,{setup:r(h),code:r(m)},null,8,["setup","code"]),e[1]||(e[1]=a("",7))])}}});export{x as __pageData,k as default};
